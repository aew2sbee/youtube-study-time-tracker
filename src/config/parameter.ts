export const system = {
  ...
  API_POLLING_INTERVAL: 5 * 60 * 1000, // 5分間隔 (5 * 60 * 1000 ms)
  TARGET_STUDY_TIME: 100 * 60 * 60, // 目標勉強時間（秒:h * m + sec ）- 100時間
  SHOW_PROGRESS_BAR: true, // 進捗バーの表示/非表示
  CRON_TIME_SILVER: 30 * 60 * 1000, // 30分（秒）
  CRON_TIME_GOLD: 1 * 60 * 60 * 1000, // 1時間（秒）
